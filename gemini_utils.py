...
def analyze_and_improve_text(text):
    ...
    prompt = f"""Please refine the following text for clarity, conciseness, and professionalism, ensuring a business-oriented style suitable for either United States English or Chilean Spanish. Ensure accurate grammar and spelling, improved word choice, and enhanced flow, while preserving the original meaning and avoiding the addition of new information.
...
Return only the revised text, clearly indicating all changes made using the following convention:
